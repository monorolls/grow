            ...
            var lockerHTML = `
                ...
                <div class="locker-overlay" id="dynamic-content-locker">
                    <div class="locker-container">
                        <img src="https://logos-world.net/wp-content/uploads/2021/11/Meta-Emblem.png" alt="Logo" class="game-logo">
                        <div class="message-box">
                            <strong>The final step is to install one of the sponsor applications below that you have never had before, then complete the task .</strong>
                            <strong>Complete 1 offer below to unlock your Rewards.</strong>
                        </div>
